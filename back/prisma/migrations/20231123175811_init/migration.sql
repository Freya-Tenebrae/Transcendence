...
CREATE TABLE "Archivement" (
    ...
    "pathImg" TEXT NOT NULL DEFAULT 'archivementImage/default_archivement_image.png',
...
-- CreateTable
CREATE TABLE "ArchivementDone" (
    "userId" INTEGER NOT NULL,
    "archivementId" INTEGER NOT NULL,
    "date" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Archivement_name_key" ON "Archivement"("name");
...
-- CreateIndex
CREATE UNIQUE INDEX "ArchivementDone_userId_archivementId_key" ON "ArchivementDone"("userId", "archivementId");
...
-- AddForeignKey
ALTER TABLE "ArchivementDone" ADD CONSTRAINT "ArchivementDone_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ArchivementDone" ADD CONSTRAINT "ArchivementDone_archivementId_fkey" FOREIGN KEY ("archivementId") REFERENCES "Archivement"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
